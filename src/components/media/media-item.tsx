...
export type MediaItemOwnProps = HelpersProps & MediaItemModifierProps;
export type MediaItemForwardsProps = {
  className: string;
};

export const MediaItem = forwardRefAs<
  "div",
  MediaItemOwnProps,
  MediaItemForwardsProps
>(
