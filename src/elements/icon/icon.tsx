...
export type IconOwnProps = HelpersProps & IconModifierProps;
export type IconForwardsProps = { className: string };

export const Icon = forwardRefAs<"span", IconOwnProps, IconForwardsProps>(
